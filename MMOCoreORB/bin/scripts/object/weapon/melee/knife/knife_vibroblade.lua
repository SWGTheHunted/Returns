...
object_weapon_melee_knife_knife_vibroblade = object_weapon_melee_knife_shared_knife_vibroblade:new {
	...
	damageType = ELECTRICTY, --alternative damage to fencers, better at some high end spots where mobs are weak to electricity. Not great damage but it's an option.
