...
object_weapon_ranged_pistol_pistol_dx2 = object_weapon_ranged_pistol_shared_pistol_dx2:new {
	...
	experimentalMin = {0, 0, 50, 95, 4.6, 8, 15, 750, 18, -90, 16, 14, 26, 46, 17},    --20% base damage buff for alternative damage option.
	experimentalMax = {0, 0, 94, 140, 3.2, 16, 60, 1500, 33, -90, 16, 30, 14, 25, 9},  --20% base damage buff for alternative damage option.
